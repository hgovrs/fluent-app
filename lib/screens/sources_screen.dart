      ...
      body: SafeArea(
        child: FutureBuilder<List<ContentSource>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasError) {
              return const Center(
                child: Padding(
                  ...
                  child: Text(
                    'Não foi possível ler as referências locais.',
            ...
            if (!snapshot.hasData) {
              return const AppLoading(semanticsLabel: 'Carregando referências');
            }
                  ...
                  children: [
                    ...
                    if (sources.isEmpty)
                      const Padding(
                        ...
                        child: Text(
                          'Esta lição utiliza somente material original.',
                          style: kSecondaryTextStyle,
                        ),
                      ),
                        ...
                        child: SurfaceCard(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              Text(
                                'Licença indicada: ${source.license}',
